{{-- File: resources/views/ecommerce/partials/modals/menunggu-penyelesaian.blade.php --}}
<div x-show="activeModal === 'menungguPenyelesaian'" x-cloak style="display: none;" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 z-50 flex items-center justify-center p-4">
    {{-- Overlay --}}
    ...
    <div @click.outside="activeModal = ''" class="bg-white rounded-lg shadow-xl overflow-hidden max-w-4xl w-full z-10" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform scale-100" x-transition:leave-end="opacity-0 transform scale-95">
        ...
        <div class="flex justify-between items-center px-6 py-4 border-b">
            <h3 class="text-lg font-bold">Menunggu Penyelesaian Transaksi</h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <template x-if="!modalData.shopee || modalData.shopee.length === 0">
                                    <tr><td colspan="4" class="px-6 py-4 text-center text-gray-500">Tidak ada transaksi menunggu penyelesaian di Shopee.</td></tr>
                                </template>
                         ...
                         <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <template x-if="!modalData.tokopedia || modalData.tokopedia.length === 0">
                                    <tr><td colspan="4" class="px-6 py-4 text-center text-gray-500">Tidak ada transaksi menunggu penyelesaian di Tokopedia.</td></tr>
                                </template>
                                {{-- [PERBAIKAN] Melakukan perulangan data dinamis --}}
