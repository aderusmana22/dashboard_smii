{{-- File: resources/views/ecommerce/partials/modals/produk-diblokir.blade.php --}}
<div
    x-show="openModal === 'produkDiblokir'"
    x-cloak
    style="display: none;"
...
>
    ...
    {{-- [MODIFIED] Konten modal diperlebar (max-w-6xl) untuk detail produk, tanpa transisi --}}
    <div
    ...
    >
        ...
        <div class="flex justify-between items-center px-6 py-4 border-b">
            <h3 class="text-lg font-bold">Produk Diblokir atau Diturunkan</h3>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Blokir</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                     <div class="text-sm text-gray-900">05 Sep 2025</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 max-w-md whitespace-normal">Pelanggaran kebijakan: Penggunaan kata kunci 'original' tanpa bukti otentikasi resmi.</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="#" class="text-orange-600 hover:text-orange-900">Perbaiki Listing</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                     ...
                     <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                     <div class="text-sm text-gray-900">01 Sep 2025</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 max-w-md whitespace-normal">Produk duplikat terdeteksi. Silakan arsipkan produk yang sama dan fokus pada satu listing.</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="#" class="text-green-600 hover:text-green-900">Perbaiki Listing</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
