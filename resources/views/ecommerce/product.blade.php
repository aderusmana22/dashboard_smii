                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                        ...
                        <div class="flex items-center space-x-2 mt-4 sm:mt-0">
                            ...
                            @if (request('show') === 'all')
                                <a href="{{ route('ecommerce.products.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                                    Show Paginated
                                </a>
                            @else
                                <a href="{{ route('ecommerce.products.index', ['show' => 'all']) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                                    Show All
                                </a>
                            @endif
