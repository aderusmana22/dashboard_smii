        ...
        <div class="relative bg-white dark:bg-gray-800 w-full max-w-lg mx-auto p-6 rounded-lg shadow-xl">
            ...
            <form id="completeJobForm" class="space-y-4" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <textarea name="note" class="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-700 shadow-sm" rows="3" required placeholder="Completion report..."></textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Final Evidence (Required)</label>
                    <input type="file" name="attachments[]" class="block w-full text-sm text-gray-500 mt-1" multiple required>
                </div>
