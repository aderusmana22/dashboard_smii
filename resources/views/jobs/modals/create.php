        ...
        <div class="relative bg-white dark:bg-gray-800 w-full max-w-lg mx-auto p-6 rounded-lg shadow-xl">
            ...
            <form id="createJobForm" class="space-y-4" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select name="area_id" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm" required>
                ...
                <div>
                    ...
                    <button type="button" class="trigger-file-input mt-2 w-full bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold py-2 px-4 border border-blue-200 rounded-md">
                        Choose or Add Files...
                    </button>
