    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div class="card rounded-xl shadow-lg overflow-hidden border border-slate-100 h-full flex flex-col">
            <div class="bg-indigo-600 px-6 py-4 flex justify-between items-center">
                ...
                <span id="fatBlendTotal" class="card/20 text-white text-xs px-2 py-1 rounded"></span>
            </div>
            ...
            <div class="card rounded-xl shadow-lg border border-slate-100 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" id="fatBlendDateStart" class="w-full card border-slate-200 text-sm rounded-lg p-2.5">
                    </div>
                    <div>
                        <label for="fatBlendDateEnd" class="block mb-1 text-xs font-semibold text-slate-500 uppercase">Tanggal Akhir</label>
                        <input type="date" id="fatBlendDateEnd" class="w-full card border-slate-200 text-sm rounded-lg p-2.5">
                    </div>
                </div>
